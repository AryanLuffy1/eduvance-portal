...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('assignments.create') }}" class="btn btn-purple">Add New Assignment</a>
</div>
        ...
        <tbody>
            @forelse($assignments as $assignment)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('assignments.edit', $assignment->id) }}" class="btn btn-sm btn-outline-light text-purple border-purple">Edit</a>
